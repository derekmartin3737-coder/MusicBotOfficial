...
// Auto-generated from: Runaway - Kanye West.mid
// Base tempo: 87.00 BPM
// Tempo override: original timing
// Effective output tempo: 87.00 BPM
// Detected MIDI note range: C#1 to E6
