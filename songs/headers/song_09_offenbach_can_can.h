...
// Strict coverage: 64 of 64 note events playable (100.0%)
// Octave transpose coverage: 64 of 64 note events playable (100.0%)
...
const uint8_t SONG_CHANNEL_COUNT = 20u;
