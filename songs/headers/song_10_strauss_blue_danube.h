...
// Strict coverage: 55 of 55 note events playable (100.0%)
// Octave transpose coverage: 55 of 55 note events playable (100.0%)
...
const uint8_t SONG_CHANNEL_COUNT = 18u;
